...
myapp.controller('addController',function($scope,$http){
    $scope.addbook = function(){
        ...
        var req = $http.post('http://127.0.0.1:3000/create',dataParams);
...
myapp.controller('homeController',function($scope,$http){
    ...
    $scope.getData=function(){
        var req = $http.get('http://127.0.0.1:3000/get');
        req.success(function(data, status, headers, config) {
            $scope.bookList = data;
            console.log(data);
        });
    ...
    $scope.delete = function(id,callback){
        ...
        $http.get('http://127.0.0.1:3000/delete/'+id)
    ...
    $scope.update = function(book,callback){
        ...
        $http.post('http://127.0.0.1:3000/update/'+book._id, dataParams)
