var Hangman = (function () {
    ...
    function Hangman(elId) {
        ...
        this.hints      = {'PROGRAMMER': ['CodeBreaker'], 'BRAINSTORM': ['Idea Generator'], 'CREATIVE': ['Out of Box'], 'LOLLIPOP': ['Kids Eating Stick'], 'CULTURE': ['traditions'], 'RAZORSHARP': ['sharp razor'], 'SCREWDRIVER': ['nail driver'], 'TYPEWRITER': ['type helper']};
        this.hintimages = {'PROGRAMMER':'Programmer.jpg', 'BRAINSTORM':'Brainstorm.jpg', 'CREATIVE':'creative.jpg', 'LOLLIPOP':'lollipop.jpg', 'CULTURE':'culture.jpg', 'RAZORSHARP':'Razorsharp.jpg', 'SCREWDRIVER':'screwdriver.jpg', 'TYPEWRITER':'typewriter.jpg'};
    }
    ...
    Hangman.prototype.hint = function() {
        ...
        document.getElementById('hintimage').innerHTML = "<img src=\"" + this.HINTIMAGES + "\" width='400px' height='400px'></img>";
    };
