        ...
        $scope.getVenues = function () {
            ...
            if (placeEntered != null && placeEntered != "" && searchQuery != null && searchQuery != "") {
                ...
                var handler = $http.get("https://api.foursquare.com/v2/venues/search" +
                    "?client_id=4ZR4RBY4GTSXU5SZSMYLS4LUP1NHYQLREZQE42W2V10SNEUI" +
                    "&client_secret=14PGALBUEWQA3BTY5JNOXW1WW2DAOP3MNNUXEWHOQNOUOKWH" +
                    "&v=20160215&limit=5" +
                    "&near=" + placeEntered +
                    "&query=" + searchQuery);
                    ...
                    if (data != null && data.response != null && data.response.venues != undefined && data.response.venues != null) {
                        ...
                        data.response.venues.forEach(function (value) {
                            ...
                            $http.get("https://api.foursquare.com/v2/venues/"+value.id+"/tips?" +
                                "client_id=4ZR4RBY4GTSXU5SZSMYLS4LUP1NHYQLREZQE42W2V10SNEUI" +
                                "&client_secret=14PGALBUEWQA3BTY5JNOXW1WW2DAOP3MNNUXEWHOQNOUOKWH&v=20160215").success(function (data) {
